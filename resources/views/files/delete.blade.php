            ...
            <div class="bg-white shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <form class="bootstrap relative"
                          action="{{route('destroyFile', ['file'=> $file->id])}}"
                          method="post">
                        @csrf

                        <h2 class="text-xl pb-4">Are you sure you want to remove the file below?</h2>
                        @include('files.details')

                        <div class="form-group w-full inline-flex space-x-4 pt-4">
